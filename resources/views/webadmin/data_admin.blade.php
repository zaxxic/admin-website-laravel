            ...
            <table class="table table-bordered border-primary">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td> <a href="cek/{{ $item->id }}"><button class="button-79" role="button">lihat</button></a> <br>
                    <form action="{{ route('update.status', $item->id) }}" method="post">
                      @csrf
                    <a href=""><button class="button-79" type="submit" role="button">Terima</button>
                    </form>
                  </a> <a href=""></a> <a href=""><button class="button-79" role="button">Tolak</button></a> <a href=""></a></td>              
          ...
          <div class="card-body">
            ...
            <table class="table table-bordered border-primary">
              ...
              <tr>
                ...
                <td><img style="margin-left: 0px;"  src="logo/{{$item->logo}}" width="100px" height="100px" alt=""></td>   
                <td> <a href="cek/{{ $item->id }}"><button class="button-79" role="button">lihat</button></a> <br>
                  <form action="/deleteadmin/{{$item->id}}" method="POST">
                    @csrf
                <button type="submit" class="button-79" role="button">Hapus</button>
                  </form>
              </td>              
